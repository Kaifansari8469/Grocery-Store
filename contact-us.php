...
if(isset($_POST['submit'])){
    ...
    $sql=mysqli_query($conn,"INSERT into tbl_contact(contact_name,contact_email,contact_subject,contact_msg) values('{$name}','{$email}','{$subject}','{$message}')") or die(mysqli_error($conn));
    if($sql)
    {
        echo "<script>alert('Thank for contact ')</script>";
    }
